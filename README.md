# Monash University Cybersecurity Bootcamp Project
...
| Web-1      | Yes Thru Load Balancer  |  LB Public IP 10.0.0.4 - JumpBox                   |
| Web-2      | Yes Thru Load Balancer  |  LB Public IP 10.0.0.4 JumpBox                     |
| ELK-Server | No                      | SSH 10.0.0.4 - JumpBox HTTP Port 5601 Private IP  |
